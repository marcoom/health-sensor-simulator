...
project = 'Health Sensor Simulator'
author = 'Marco Mongi'
...
htmlhelp_basename = 'health_sensor_simulator_docs'
...
latex_elements = {
    ...
    # Additional settings
    'inputenc': '',
    'babel': r'\usepackage[spanish,english]{babel}',
    'maxlistdepth': '100',
    'sphinxsetup': 'verbatimwithframe=false,VerbatimColor={rgb}{0.95,0.95,0.95}',
    'passoptionstopackages': r'\PassOptionsToPackage{spanish,english}{babel}',
}
...
latex_documents = [
    (master_doc, 'health-sensor-simulator.tex', project + ' Documentation',
     author, 'manual', False),
]
...
texinfo_documents = [
    (master_doc, project, project + ' Documentation',
     author, project, 'Health variables sensor simulator with rest API and anomaly detection model',
     'Miscellaneous'),
]
